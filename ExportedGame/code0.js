...
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerObjects1.length;i<l;++i) {
    if ( !(gdjs.New_32sceneCode.GDPlayerObjects1[i].isCurrentAnimationName("NormalAttack")) ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
